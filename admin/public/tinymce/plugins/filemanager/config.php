...
$base_url="http://parkwaycasper.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/upload_image/'; // path from base_url to upload base dir
$current_path = '../../../../upload_image/'; // relative path from filemanager folder to upload files folder
